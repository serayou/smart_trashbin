...
int init_socket(mqtt_broker_handle_t* broker, const char* hostname, short port)
{
  ...
  Stringto_Ipaddr(Chconfig_Type_Def.destip, hostname);
  ...
  while(1)
  {
    ...
    else if(packet_length > 0)
    {
      ...
      if(MQTTParseMessageType(packet_buffer) == MQTT_MSG_PUBLISH)
      {
        ...
        case 'C':
          Lcd_Init();
          Lcd_Draw_Bar(20,30,85,110,BLUE);
          Lcd_Draw_Rect(20,20,85,110,RED);
          break;
